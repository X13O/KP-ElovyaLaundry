                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <div class="input-group">
                                                <select name="category_id" id="category_id"
                                                    ...
                                                    <option value="<?php echo e($categoryItem->id); ?>"><?php echo e($categoryItem->nama_kategori); ?></option>
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <div class="input-group">
                                                <select name="tipe_harga_id" id="tipe_harga_id"
                                                    class="form-control form-control-sm border-right-0" required>
                                                    <?php $__currentLoopData = $tipe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipeItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($tipeItem->id); ?>"
                                                        data-harga="<?php echo e($tipeItem->tipe_harga); ?>"><?php echo e($tipeItem->tipe_harga); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
...
</body><?php /**PATH D:\KP\projectKP\Websitenya\elovya-laundry\resources\views/dashboard/admin/index.blade.php ENDPATH**/ ?>