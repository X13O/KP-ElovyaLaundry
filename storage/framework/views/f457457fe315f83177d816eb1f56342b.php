                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body table-responsive">
                                <a href="#" id="cetakLaporanBtn" class="btn btn-success mt-2 mb-3 no-print">Cetak
                                    Laporan</a>
                                <table class="table table-striped table-bordered table-sm dt-responsive nowrap"
                                    ...
                                    <thead class="thead-primary">
                                        <tr>
                                            ...
                                            <th class="small font-weight-bold">Kode Transaksi</th>
                                            ...
                                            <th class="small font-weight-bold">Status Transaksi</th>
                                            <th class="small font-weight-bold no-print">Opsi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $__currentLoopData = $transaksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dataTransaksi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="text-left ">
                                            <td><?php echo e($loop->iteration); ?></td>
                                            <td><?php echo e($dataTransaksi->kapan_dibuat); ?></td>
                                            <td><?php echo e($dataTransaksi->kode_transaksi); ?></td>
                                            <td><?php echo e($dataTransaksi->nama_konsumen); ?></td>
                                            <td><?php echo e($dataTransaksi->nomor_konsumen); ?></td>
                                            <td><?php echo e(optional($dataTransaksi->category)->nama_kategori ?? 'Kategori Cucian
                                                Dihapus atau Kosong!!'); ?></td>
                                            <td>
                                                <?php if($dataTransaksi->tipe &&
                                                is_numeric($dataTransaksi->tipe->tipe_harga)): ?>
                                                <?php echo 'Rp. ' . number_format($dataTransaksi->tipe->tipe_harga, 0, ',', '.'); ?>
                                                <?php else: ?>
                                                Tipe Harga Cucian Dihapus atau Kosong!!
                                                <?php endif; ?>
                                            </td>
                                            <td><?php echo e($dataTransaksi->berat_cucian); ?></td>
                                            <td><?php echo 'Rp. ' . number_format($dataTransaksi->total_harga, 0, ',', '.'); ?></td>
                                            <td><?php echo e($dataTransaksi->status_transaksi); ?></td>
                                            <td class="no-print">
                                                <a href="/dashboard/admin/laporan/<?php echo e($dataTransaksi->id); ?>"
                                                    class="badge bg-primary text-white mt-2 mb-2"><span
                                                        data-feather="eye"></span></a>
                                                <a href="/dashboard/admin/laporan/<?php echo e($dataTransaksi->id); ?>/edit"
                                                    class="badge bg-warning text-white mt-2 mb-2"><span
                                                        data-feather="edit"></span></a>
                                                <form action="/dashboard/admin/laporan/<?php echo e($dataTransaksi->id); ?>"
                                                    method="POST" class="d-inline">
                                                    <?php echo method_field('delete'); ?>
                                                    <?php echo csrf_field(); ?>
                                                    <button class="badge bg-danger border-0 text-white mt-2 mb-2"
                                                        onclick="return confirm('Yakin Mau Hapus Data Transaksi <?php echo e($dataTransaksi->nama_konsumen); ?>??')"><span
...
</body><?php /**PATH D:\KP\projectKP\Websitenya\elovya-laundry\resources\views/dashboard/laporan/index.blade.php ENDPATH**/ ?>