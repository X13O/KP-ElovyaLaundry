                    ...
                    <div class="col-md-12 mb-3">
                        <div class="card">
                            <div class="card-body py-4">
                                <form method="POST" action="/dashboard/admin/laporan/<?php echo e($transaksi->id); ?>">
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <input type="text" class="form-control form-control-sm" name="tgl_transaksi"
                                                id="tgl_transaksi" value="<?php echo e($transaksi->kapan_dibuat); ?>" readonly>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <input type="text" class="form-control form-control-sm"
                                                ...
                                                value="<?php echo e($transaksi->kode_transaksi); ?>" readonly>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <div class="input-group">
                                                <input type="text" name="nama_konsumen" id="nama_konsumen"
                                                    ...
                                                    value="<?php echo e($transaksi->nama_konsumen); ?>" readonly>
                                            </div>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <div class="input-group">
                                                <input type="text" name="nomor_konsumen" id="nomor_konsumen"
                                                    class="form-control form-control-sm border-right-0"
                                                    value="<?php echo e($transaksi->nomor_konsumen); ?>" readonly>
                                            </div>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <div class="input-group">
                                                <input type="text" name="category_id" id="category_id"
                                                    class="form-control form-control-sm border-right-0"
                                                    value="<?php echo e($transaksi->category_id); ?>" readonly>
                                            </div>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                            for="tipe_harga_id"><b>Tipe
                                                Cucian / Harga cucian per hari</b></label>
                                        <div class="col-sm-8 mb-2">
                                            <input type="text" class="form-control form-control-sm" name="tipe_harga_id"
                                                id="tipe_harga_id" value="<?php echo e($transaksi->tipe_cucian_id); ?>" readonly>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <input type="number" class="form-control form-control-sm"
                                                name="berat_cucian" id="berat_cucian"
                                                value="<?php echo e($transaksi->berat_cucian); ?>" readonly>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group mb-2">
                                                <input type="text" class="form-control form-control-sm" id="total_harga"
                                                    name="total_harga" value="<?php echo e($transaksi->total_harga); ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <input type="text" class="form-control form-control-sm" name="bayar"
                                                id="bayar" value="<?php echo e($transaksi->bayar); ?>" readonly>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group mb-2">
                                                <input type="text" class="form-control form-control-sm" id="kembalian"
                                                    name="kembalian" value="<?php echo e($transaksi->kembalian); ?>" readonly>
                                            </div>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <select class="form-select" name="status_transaksi">
                                                <option><?php echo e($transaksi->status_transaksi); ?></option>
                                                <option>Proses Selesai, Silahkan Diambil</option>
                                            </select>
                                        </div>
                                    </div>
...
</body><?php /**PATH D:\KP\projectKP\Websitenya\elovya-laundry\resources\views/dashboard/laporan/edit.blade.php ENDPATH**/ ?>