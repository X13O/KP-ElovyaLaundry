                                ...
                                <form method="POST" action="/dashboard/admin/laporan">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <?php $__currentLoopData = $tipe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dataTipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="text-left ">
                                                    <td class="text-left text-lg-left"><?php echo e($loop->iteration); ?></td>
                                                    <td class="text-left text-lg-left"><?php echo e($dataTipe->tipe_harga); ?></td>
                                                    <td class="text-left text-lg-left">
                                                        <a href="/dashboard/admin/tipe/<?php echo e($dataTipe->id); ?>/edit"
                                                            class="badge bg-warning text-white mt-2 mb-2 "><i
                                                                class="bi bi-pencil" style="font-size: 1.7em;"></i></a>
                                                        <form action="/dashboard/admin/tipe/<?php echo e($dataTipe->id); ?>"
                                                            method="POST" class="d-inline">
                                                            <?php echo method_field('delete'); ?>
                                                            <?php echo csrf_field(); ?>
                                                            <button
                                                                class="badge bg-danger border-0 text-white mt-2 mb-2"
                                                                onclick="return confirm('Yakin Mau Hapus Tipe Cucian <?php echo e($dataTipe->tipe_harga); ?>??')"><i
...
</body><?php /**PATH D:\KP\projectKP\Websitenya\elovya-laundry\resources\views/dashboard/tipe/index.blade.php ENDPATH**/ ?>