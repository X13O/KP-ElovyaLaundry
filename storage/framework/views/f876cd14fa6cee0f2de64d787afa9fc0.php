            ...
            <div class="col-md-6 mb-2">
                <div class="row">
                    <div
                        ...
                        <h2>Tambah Tipe Cucian Baru</h2>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="card">
                            <div class="card-body py-4">
                                <form method="POST" action="/dashboard/admin/tipe">
                                    <?php echo csrf_field(); ?>
                                    <div class="mb-3">
                                        <label for="tipe_harga" class="form-label">Harga Tipe Cucian Baru</label>
...
</body><?php /**PATH D:\KP\projectKP\Websitenya\elovya-laundry\resources\views/dashboard/tipe/create.blade.php ENDPATH**/ ?>