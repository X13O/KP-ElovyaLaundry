            ...
            <div class="col-md-6 mb-2">
                <div class="row">
                    <div
                        ...
                        <h2>Edit Harga Tipe Cucian</h2>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="card">
                            <div class="card-body py-4">
                                <form method="POST" action="/dashboard/admin/tipe/<?php echo e($tipe->id); ?>">
                                    <?php echo method_field('put'); ?>
                                    <?php echo csrf_field(); ?>
                                    <div class="mb-3">
                                        <label for="tipe_harga" class="form-label">Harga Tipe Cucian</label>
                                        <input type="text" class="form-control" id="tipe_harga" name="tipe_harga"
                                            value="<?php echo e($tipe->tipe_harga); ?>">
                                    </div>
...
</body><?php /**PATH D:\KP\projectKP\Websitenya\elovya-laundry\resources\views/dashboard/tipe/edit.blade.php ENDPATH**/ ?>