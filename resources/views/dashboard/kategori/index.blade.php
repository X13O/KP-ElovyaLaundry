                                            ...
                                            <tbody>
                                                ...
                                                <tr class="text-left ">
                                                    ...
                                                    <td class="text-left text-lg-left">{{
                                                        $dataCategory->nama_kategori
                                                        }}</td>
                                                    <td class="text-left text-lg-left">
                                                        <a href="/dashboard/admin/kategori/{{ $dataCategory->id }}/edit"
                                                            class="badge bg-warning text-white mt-2 mb-2 "><i
                                                                class="bi bi-pencil" style="font-size: 1.7em;"></i></a>
                                                        <form action="/dashboard/admin/kategori/{{ $dataCategory->id }}"
                                                            method="POST" class="d-inline">
                                                            @method('delete')
                                                            @csrf
                                                            <button
                                                                class="badge bg-danger border-0 text-white mt-2 mb-2"
                                                                onclick="return confirm('Yakin Mau Hapus Kategori {{ $dataCategory->nama_kategori }}??')"><i
