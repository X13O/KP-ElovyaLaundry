                    ...
                    <div class="card-header bg-white border-0 pb-0 pt-4">
                        <div class="row">
                            <div class="col-8 col-sm-9 pr-0">
                                ...
                                <ul class="pl-0 small" style="list-style: none;text-transform: uppercase;">
                                    <li>KODE TRANSAKSI : {{ $post->kode_transaksi }}</li>
                                </ul>
                            </div>
                    ...
                    <div class="card-body small pt-0">
                        ...
                        <div class="row">
                            <div class="col-3 pr-0">
                                ...
                                <p>{{ $post->category->nama_kategori }}</p>
                            </div>
                            ...
                            <div class="col-4 px-0 text-center">
                                ...
                                <span>
                                    @if ($post->tipe && is_numeric($post->tipe->tipe_harga))
                                    @currency($post->tipe->tipe_harga)
                                    @else
                            ...
                            <div class="col-12">
                                ...
                                <ul class="list-group border-0">
                                    ...
                                    <li
                                        class="list-group-item p-0 border-0 d-flex justify-content-between align-items-center mt-2">
                                        <b>Total Harga</b>
                                        <span>@currency($post->total_harga)</span>
                                    </li>
                                    <li
                                        class="list-group-item p-0 border-0 d-flex justify-content-between align-items-center mt-2">
                                        <b>Bayar</b>
                                        <span>@currency($post->bayar)</span>
                                    </li>
                                    <li
                                        class="list-group-item p-0 border-0 d-flex justify-content-between align-items-center mt-2">
                                        <b>Kembalian</b>
                                    ...
                                    <li
                                        ...
                                        <span>{{ $post->status_transaksi }}</span>
                                    </li>
                                </ul>
                            </div>
