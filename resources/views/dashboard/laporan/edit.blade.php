                    ...
                    <div class="col-md-12 mb-3">
                        <div class="card">
                            <div class="card-body py-4">
                                <form method="POST" action="/dashboard/admin/laporan/{{ $transaksi->id }}">
                                    @method('put')
                                    @csrf
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <input type="text" class="form-control form-control-sm" name="tgl_transaksi"
                                                id="tgl_transaksi" value="{{ $transaksi->kapan_dibuat }}" readonly>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <div class="input-group">
                                                <input type="text" name="nama_konsumen" id="nama_konsumen"
                                                    ...
                                                    value="{{ $transaksi->nama_konsumen }}" readonly>
                                            </div>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <div class="input-group">
                                                <input type="text" name="nomor_konsumen" id="nomor_konsumen"
                                                    class="form-control form-control-sm border-right-0"
                                                    value="{{ $transaksi->nomor_konsumen }}" readonly>
                                            </div>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <div class="input-group">
                                                <input type="text" name="category_id" id="category_id"
                                                    class="form-control form-control-sm border-right-0"
                                                    value="{{ $transaksi->category_id }}" readonly>
                                            </div>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <input type="text" class="form-control form-control-sm" name="tipe_harga_id"
                                                id="tipe_harga_id" value="{{ $transaksi->tipe_cucian_id }}" readonly>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <input type="number" class="form-control form-control-sm"
                                                ...
                                                value="{{ $transaksi->berat_cucian }}" readonly>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group mb-2">
                                                <input type="text" class="form-control form-control-sm" id="total_harga"
                                                    name="total_harga" value="{{ $transaksi->total_harga }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-8 mb-2">
                                            <input type="text" class="form-control form-control-sm" name="bayar"
                                                id="bayar" value="{{ $transaksi->bayar }}" readonly>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group mb-2">
                                                <input type="text" class="form-control form-control-sm" id="kembalian"
                                                    name="kembalian" value="{{ $transaksi->kembalian }}" readonly>
                                            </div>
                                        </div>
                                        <label class="col-sm-4 col-form-label col-form-label-sm"
