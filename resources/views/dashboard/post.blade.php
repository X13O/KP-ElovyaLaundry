...
<head>
    ...
    <link href="{{ asset('css/userStyle/style.css') }}" rel="stylesheet">
    <!-- PWA  -->
                        ...
                        <div class="row">
                            <div class="col-8 col-sm-9 pr-0">
                                <ul class="pl-0 small" style="list-style: none;text-transform: uppercase;">
                                    <li>KODE TRANSAKSI : {{ $singlePost->kode_transaksi }}</li>
                                </ul>
                            </div>
                            <div class="col-4 col-sm-3 pl-0">
                                <ul class="pl-0 small" style="list-style: none;">
                                    <li>TGL : {{ $singlePost->kapan_dibuat }}
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="card-body small pt-0">
                        ...
                        <div class="row">
                            <div class="col-3 pr-0">
                                ...
                                <p>{{ $singlePost->category->nama_kategori }}</p>
                            </div>
                            <div class="col-5 px-0 text-center">
                                <span><b>Berat Cucian / Kg</b></span><br>
                                <span class="pt-5">{{ $singlePost->berat_cucian }} / Kg</span>
                            </div>
                            <div class="col-4 px-0 text-center">
                                <span><b>Tipe Cucian / Hari</b></span><br>
                                <span>
                                    @if ($singlePost->tipe && is_numeric($singlePost->tipe->tipe_harga))
                                    @currency($singlePost->tipe->tipe_harga)
                                    @else
                            ...
                            <div class="col-12">
                                ...
                                <ul class="list-group border-0">
                                    <li
                                        ...
                                        <b>Nama Konsumen</b>
                                        <span>{{ $singlePost->nama_konsumen }}</span>
                                    </li>
                                    <li class="list-group-item p-0 border-0 d-flex justify-content-between align-items-center mt-2"
                                        id="nomorKonsumen" data-nomor="{{ $singlePost->nomor_konsumen }}">
                                        <b>Nomor Whatsapp Konsumen</b>
                                        <span>{{ $singlePost->nomor_konsumen }}</span>
                                    </li>
                                    <li
                                        class="list-group-item p-0 border-0 d-flex justify-content-between align-items-center mt-2">
                                        <b>Total Harga</b>
                                        <span>@currency($singlePost->total_harga)</span>
                                    </li>
                                    <li
                                        class="list-group-item p-0 border-0 d-flex justify-content-between align-items-center mt-2">
                                        <b>Bayar</b>
                                        <span>@currency($singlePost->bayar)</span>
                                    </li>
                                    <li
                                        class="list-group-item p-0 border-0 d-flex justify-content-between align-items-center mt-2">
                                        <b>Kembalian</b>
                                        <span>{{ $singlePost->kembalian }}</span>
                                    </li>
                                    <li
                                        class="list-group-item p-0 border-0 d-flex justify-content-between align-items-center mt-2">
                                        <b>Status Transaksi</b>
                                        <span>{{ $singlePost->status_transaksi }}</span>
                                    </li>
                                </ul>
                            </div>
