                                ...
                                <table class="table table-striped table-bordered table-sm dt-responsive nowrap"
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-left ">
                                            ...
                                            <td>{{ $dataPelanggan->role }}</td>
                                            <td class="no-print">
                                                <a href="/dashboard/admin/pelanggan/{{ $dataPelanggan->id }}/edit"
                                                    class="badge bg-warning text-white mt-2 mb-2"><span
                                                        data-feather="edit"></span></a>
                                                <form action="/dashboard/admin/pelanggan/{{ $dataPelanggan->id }}"
                                                    method="POST" class="d-inline">
                                                    @method('delete')
                                                    @csrf
                                                    <button class="badge bg-danger border-0 text-white mt-2 mb-2"
                                                        onclick="return confirm('Yakin Mau Hapus Data Pelanggan {{ $dataPelanggan->username }}??')"><span
